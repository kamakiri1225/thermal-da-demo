...
| サンプル | 内容 | 主な手法 | 状態 |
|---|---|---|---|
| `sample/001_kalman_thermal_1d` | Python だけで動く 1 次元熱伝導デモ | Kalman filter | 実装済み |
| `sample/002_laplacian_da_1d` | OpenFOAM `laplacianFoam` と Python をつなぐデータ同化デモ | optimal interpolation | 実装済み |
