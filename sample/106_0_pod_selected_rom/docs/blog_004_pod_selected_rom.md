...
**具体例（ $k=3$ ）**：ある節点 $p$ の近くに3つのセルがあり、距離と温度が

$$d_1=1\,\mathrm{mm}\ (T_1=25\,^\circ\mathrm C),\quad
d_2=2\,\mathrm{mm}\ (T_2=23\,^\circ\mathrm C),\quad
d_3=4\,\mathrm{mm}\ (T_3=21\,^\circ\mathrm C)$$

だったとします。まず重みは距離の逆数（**近いほど大きい／半分の距離なら2倍の重み**）:

$$w_1=\frac1{d_1}=1,\qquad w_2=\frac1{d_2}=0.5,\qquad w_3=\frac1{d_3}=0.25.$$

これを式に入れて、分子（重み付き和）と分母（重みの和）を計算すると:

$$T_p=\frac{w_1T_1+w_2T_2+w_3T_3}{w_1+w_2+w_3}
=\frac{1\times25+0.5\times23+0.25\times21}{1+0.5+0.25}
=\frac{25+11.5+5.25}{1.75}
=\frac{41.75}{1.75}\approx23.9\,^\circ\mathrm C.$$

**一番近いセル（25℃, 重み1）に最も引っ張られ、遠いセルほど効きが弱い**のが数字で見えます。
