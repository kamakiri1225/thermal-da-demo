...
最小実行(20s)の後、**0→600s(ヒータON 0-300s→OFF)を10サイクル**で完走:
...
![発熱量Qの推定: 60sで急収束→240s以降は真値15Wに固定(0-600s) ](assets/openfoam_fem_enkf_Q.png)

**要点：600s全過程でも同化は破綻せず、Qは加熱中に確定し冷却中も場が真値追従。**
